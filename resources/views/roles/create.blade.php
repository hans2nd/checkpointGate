        ...
        <form method="POST" action="{{ route('roles.store') }}">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden mb-6">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-800">Informasi Role</h2>
                    <p class="text-sm text-gray-500 mt-0.5">Buat role baru untuk mengatur akses user</p>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden mb-6">
                <div class="px-6 py-4 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-lg font-semibold text-gray-800">Pilih Permission</h2>
                        ...
                        <div class="mb-6 last:mb-0">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 pl-4">
                                @foreach($perms as $permission)
                                    <label class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors group-perm-{{ Str::slug($group) }}">
