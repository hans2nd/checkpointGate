        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6 z-10">
                ...
                <form method="POST" action="{{ route('checkpoints.import') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Pilih File Excel (.xlsx)') }}</label>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6 z-10">
                ...
                <form id="cancelForm" method="POST" action="">
                    @csrf
                    <div class="mb-4">
                        <label for="cancel_note" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Catatan Cancel') }}
                        ...
                        <p class="text-xs text-gray-400 mt-1">{{ __('Catatan ini akan tampil di tabel, detail, dan export Excel.') }}</p>
                    </div>
                    <div class="flex justify-end gap-2">
