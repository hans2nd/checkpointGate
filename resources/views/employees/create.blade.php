...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="premium-form-card">
        <div class="form-header flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-white">Tambah Employee Baru</h2>
                <p class="text-slate-300 mt-1 text-sm font-medium">Employee dapat login menggunakan Employee ID</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('employees.store') }}" class="p-8">
            ...
            <div class="space-y-6">
                <div class="form-group">
                    ...
                    <input type="text" id="employee_id" name="employee_id" value="{{ old('employee_id') }}" required placeholder="Contoh: EMP001, STF-123"
                           class="premium-input uppercase">
                    <p class="mt-1.5 text-xs font-semibold text-gray-400">ID unik sebagai credential login (tanpa password)</p>
                </div>
                ...
                <div class="p-5 bg-blue-50 border border-blue-200 rounded-xl mt-4">
                    <label class="flex items-start gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="create_user" value="1"
                               class="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-600 mt-0.5">
                        <div>
                            <span class="text-sm font-bold text-blue-900">Tambahkan juga sebagai User</span>
                            <p class="text-xs font-medium text-blue-700 mt-1 leading-relaxed">Jika dicentang, employee ini juga akan terdaftar di User Management dengan role yang sama.</p>
                        </div>
                    </label>
                </div>
            </div>
