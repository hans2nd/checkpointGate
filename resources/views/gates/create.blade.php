...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-800">Tambah Gate Baru</h2>
        </div>

        <form method="POST" action="{{ route('gates.store') }}" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="number" id="nomor_gate" name="nomor_gate" value="{{ old('nomor_gate') }}" required min="1"
                ...
                <div>
                    ...
                    <select id="aktivitas" name="aktivitas" required
                        ...
                        <option value="OUTBOUND" {{ old('aktivitas') == 'OUTBOUND' ? 'selected' : '' }}>OUTBOUND</option>
                    </select>
                </div>
            </div>
