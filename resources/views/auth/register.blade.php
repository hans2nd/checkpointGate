...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-slate-400 text-sm mt-1">Daftar untuk mengakses Checkpoint GIIC</p>
    </div>
    ...
    <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-white/10">
        ...
        <p class="mt-6 text-center text-sm text-slate-400">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-orange-400 hover:text-orange-300 font-medium transition-colors">Masuk</a>
        </p>
    </div>
</div>
@endsection
