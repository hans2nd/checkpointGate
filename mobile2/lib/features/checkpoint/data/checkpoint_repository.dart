...
class CheckpointRepository {
  ...
  Future<void> createCheckpoint(Map<String, dynamic> data) async {
    try {
      await _dio.post('/checkpoints', data: data);
    } catch (e) {
      if (e is DioException && e.response != null) {
         ...
         throw Exception(errorData['message'] ?? 'Error creating checkpoint');
      }
      throw Exception('Gagal menambahkan kedatangan: $e');
    }
  }
}
